...
<body>
  ...
  <section class="restaurant-detailed-banner">
    <div class="col-lg-12 d-none d-lg-block">
      <div class="text-center">
        <img class="img-fluid cover" src="https://bestellen.brood2day.nl/images/header.jpg">
      </div>
          ...
          <div class="row d-flex align-items-end">
            <div class="col-md-12">
              <div class="restaurant-detailed-header-left">
                <!--<img class="img-fluid mr-3 float-left" alt="logo" src="https://bestellen.brood2day.nl/images/brood2day_transparant.png">-->
                <h2 class="text-white">Brood2day</h2>
              ...
              <p></p>
              <p class="text-white mb-0"><i class="icofont-food-cart"></i> Voor de lekkerste broodjes en Catering
              </p>
            </div>
          </div>
          <div class="col-md-4">
  ...
  <section class="offer-dedicated-nav bg-white border-top-0 shadow-lg">
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel" aria-labelledby="pills-order-online-tab">
              <div id="#menu" class="sticky-top">
                <div class="owl-carousel owl-theme owl-carousel-five offers-interested-carousel mb-1 owl-loaded owl-drag">
                ...
                <div class="owl-stage-outer rounded"><div class="owl-stage" style="transform: translate3d(-1611px, 0px, 0px); transition: all 0s ease 0s; width: 6447px;"><div class="owl-item cloned" style="width: 201.448px;"><div class="item">
                    <div class="mall-category-item">
                      <a href="#">
                        <h6>Pizzas</h6>
                      </a>
                    </div>
                  </div></div><div class="owl-item cloned" style="width: 201.448px;"><div class="item">
                    <div class="mall-category-item">
                      <a href="#">
                        <h6>Pastas</h6>
                      </a>
                  ...
                  </div></div><div class="owl-item active" style="width: 201.448px;"><div class="item">
                    <div class="mall-category-item">
                      <a href="#">
                        <h6>Burgers</h6>
                      </a>
                  ...
                  </div></div><div class="owl-item" style="width: 201.448px;"><div class="item">
                    <div class="mall-category-item">
                      <a href="#">
                        <h6>Chinese</h6>
                      </a>
                  ...
                  </div></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i class="icofont-thin-left"></i></button><button type="button" role="presentation" class="owl-next"><i class="icofont-thin-right"></i></button></div><div class="owl-dots disabled"></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><i class="icofont-thin-left"></i></button><button type="button" role="presentation" class="owl-next"><i class="icofont-thin-right"></i></button></div><div class="owl-dots disabled"></div></div>
              </div>
              <div class="row">
                        ...
                        <div class="media">
                          ...
                          <a href="#">
                            <img class="mr-3 rounded-pill" src="img/2.jpg" alt="Generic placeholder image">
                              ...
                              <h6 class="mb-1">Stuffed Mushroom </h6>
                              <p class="text-gray mb-0">Heerljke gevulde paddenstoellen.</p>
                            </a> <span class="badge badge-info">NEW</span> <span class="float-right">
                      ...
                      <div class="list-card-image">
                        <div class="menu-list p-3 border-bottom">
                          <div class="media">
                            ...
                            <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                            <a href="#">
                              <img class="mr-3 rounded-pill" src="img/list/8.png" alt="Generic placeholder image">
                              </a><div class="media-body"><a href="#">
                                <h6 class="mb-1">Stuffed Mushroom </h6>
                                <p class="text-gray mb-0">Heerljke gevulde paddenstoellen.</p>
                              </a> <span class="badge badge-info">NEW</span> <span class="float-right">
                        ...
                        <div class="list-card-image">
                          <div class="menu-list p-3 border-bottom">
                            <div class="media">
                              ...
                              <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                              <a href="#">
                                <img class="mr-3 rounded-pill" src="img/list/6.png" alt="Generic placeholder image">
                                </a><div class="media-body"><a href="#">
                                  <h6 class="mb-1">Stuffed Mushroom </h6>
                                  <p class="text-gray mb-0">Heerljke gevulde paddenstoellen.</p>
                                </a> <span class="badge badge-info">NEW</span> <span class="float-right">
                              ...
                              <div class="col-md-4 col-sm-6 mb-4">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4 col-sm-6 mb-4">
                                                ...
                                                <div class="list-card-image">
                                                  <div class="menu-list p-3 border-bottom">
                                                    <div class="media">
                                                      ...
                                                      <a href="#">
                                                        <img class="mr-3 rounded-pill" src="img/list/6.png" alt="Generic placeholder image">
                                                      </a><div class="media-body"><a href="#" data-toggle="modal" data-target="#productinfo">
                                                          <h6 class="mb-1">Stuffed Mushroom </h6>
                                                          <p class="text-gray mb-0">Heerljke gevulde paddenstoellen.</p>
                                                        </a> <span class="badge badge-info">NEW</span> <span class="float-right">
                                                          <a class="btn btn-outline-secondary btn-sm" href="#">ADD</a>
                                    ...
                                    <!--bestelling winkelwagen en hide voor mobiel scherm-->
                                    <div class="col-lg-3 d-none d-lg-block">
                                      <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item sticky-top border-bottom">
                                        <h5 class="mb-1 text-black">Uw Bestelling</h5>
                                        <p class="mb-4 text-black">6 ITEMS</p>
                                        ...
                                        <a href="checkout.html" class="btn btn-success btn-block btn-lg">Afrekenen <i class="icofont-cart-alt"></i></a>
                                      </div>
                                    </div>
                                  </div>
                                  <!-- Afreken button mobiel device-->
                                  <div class="container">
                                    <div class="col-md-12 d-lg-none" style="z-index:9000 !important; width: 100% !important; position:fixed !important; bottom:10px !important; left:0px !important;">
                                      <button class="btn btn-lg btn-success btn-block">Afrekenen</button>
                                    </div>

                                    <!-- modal for product info-->

<div class="modal fade" id="productinfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
                    ...
                    <h6 class="mb-3">Schrijf je in op onze nieuwsbrief</h6>
                    <form class="newsletter-form mb-1">
                    <div class="input-group">
                    <input type="text" placeholder="Vul hier je email adres in" class="form-control">
...
<footer class="pt-0 pb-4 text-center">
  <div class="container">
    <p class="mt-0 mb-0">© Copyright 2020 ODS. All Rights Reserved</p>
  </div>
</footer>
<div class="col-md-12 d-lg-none" style="padding-bottom:50px;"></div>

<!-- jQuery -->
<script async="" src="https://www.google-analytics.com/analytics.js"></script><script async="" src="https://www.google-analytics.com/analytics.js"></script><script src="vendor/jquery/jquery.min.js"></script>
<!--JQuery.sticky-->
...
$("#sticker").sticky({bottomspacing:2000});
});
</script>-->
