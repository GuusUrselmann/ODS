...
@section('content_header')
    <h1><a class="h6" href="{{url()->previous()}}"><i class="fas fa-arrow-left"></i></a> Product Bewerken</h1>
@stop
@section('content')
    <div class="row">
        <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="form-group col-8">
                                ...
                                <div class="standard-extras-field" id="extraOptionsField">
                                    @foreach($product_extra_options as $i => $extra_option)
                                        @if($extra_option->options[0]->standard_extra_id)
                                            <div class="extra-options border-top border-secondary pt-2" data-id="{{$i}}">
                                                <input type="hidden" name="extraOptions[{{$i}}][type]" value="standardExtra">
                                                <input type="hidden" name="extraOptions[{{$i}}][standardExtraID]" value="{{$extra_option->id}}">
                                                <div class="options-header">
                                                <div class="form-row mb-3">
                                                    <div class="form-group col-6">
                                                        <input type="text" value="{{$extra_option->name}}" class="form-control" disabled>
                                                    </div>
                                                    <div class="form-group col-6">
                                                        <b>Type: {{$extra_option->type}}</b>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="options-field">
                                                    @foreach($extra_option->options as $j => $option)
                                                        <div class="option">
                                                            <div class="form-row">
                                                                <div class="form-group col-8">
                                        ...
                                        @elseif($extra_option->options[0]->product_extra_id)
                                            <div class="extra-options border-top border-secondary pt-2" data-id="{{$i}}">
                                                <input type="hidden" name="extraOptions[{{$i}}][type]" value="{{$extra_option->type}}">
                                                <div class="options-header">
                                                    <div class="form-row mb-3">
                                                        <div class="form-group col-6">
                                                            <input type="text" class="form-control" placeholder="Naam" name="extraOptions[{{$i}}][name]" value="{{$extra_option->name}}" required>
                                                        </div>
                                                        <div class="form-group col-6">
                                                            <b>Type: {{$extra_option->type}}</b>
                                                        </div>
                                                ...
                                                <div class="options-field">
                                                    @foreach($extra_option->options as $j => $option)
                                                        <div class="option" data-id="0">
                                                            <div class="form-row">
                                                                <div class="form-group col-8">
                                                                    <input type="text" class="form-control" placeholder="Keuze" name="extraOptions[{{$i}}][options][{{$j}}][name]" value="{{$option->name}}" required>
                                                                </div>
                                                                <div class="form-group col-4">
                                                                    <div class="input-group">
                                                                        <div class="input-group-prepend">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="00,00" name="extraOptions[{{$i}}][options][{{$j}}][extra_amount]" value="{{$option->extra_amount}}">
                                                                    </div>
                                                                </div>
